...
def a_star_search(problem):
    ...
    frontier = [(g_costs[initial_state] + h_costs[initial_state], g_costs[initial_state], initial_state)]
    while frontier:
        _, current_g_cost, current_state = heapq.heappop(frontier)
        ...
        for neighbor_state, neighbor_weight in state_space[current_state].items():
            ...
            if new_g_cost < g_costs[neighbor_state]:
                ...
                heapq.heappush(frontier, (new_g_cost + h_costs[neighbor_state], new_g_cost, neighbor_state))
